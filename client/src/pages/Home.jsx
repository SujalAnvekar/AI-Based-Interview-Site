        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              transition={{ duration: 0.5 }} className='text-4xl md:text-6xl font-semibold
            leading-tight max-w-4xl mx-auto'>
              Practice Interviews with
              <span className='relative inline-block'>
                <span className='bg-green-100 text-green-600 py- px-5 rounded-full'>
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
        ...
        gap-10 mb-28'>
            {
              [
                ...
                ${index === 0 ? "rounded-[-4deg]" : ""}
                ${index === 1 ? "rounded-[3deg] md:-mt-6 shadow-xl" : ""}
                ${index === 2 ? "rounded-[-3deg]" : ""}`
                  }>
...
items-center justify-center shadow-lg'>
                  ...
                  <div className='pt-10 text-center'>
                    <div className='text-xs test-green-600 font-semibold mb-2 tracking-widest'>
                      {item.step}</div>
                ...
                [
                  {
                    ...
                    desc: "communication, technical accuracy and confidence"
                  },
                  {
                    image: resumeImg,
                  ...
                  },
                  {
                    ...
                    desc: "Track progres with performance graphs and topics analysis."
                  },
                ].map((item, index) => (
                  <motion.div
                    initial={{ opacity: 0, y: 30 }}
                ...
                rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                    ...
                    <h3 className='font-semibold text-xl mb-3'>
                      ...
                      <p className='text-gray-500 text-sm leading-relaxed'>{mode.desc}
                        ...
                        className='w-28 h-28 object-contain'/></div>
                    </div>
                  </motion.div>
                ))
              }
