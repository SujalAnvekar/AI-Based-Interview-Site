...
<div className='mb-10 w-full flex flex-wrap items-start gap-4'>
    <button
    onClick={(()=>navigate('/'))}
    className='mt-1 p-3 rounded-full bg-white shadow hover:shadow-md transiton'>
        <FaArrowLeft className='text-gary-600'/></button>

    <div>
        <h1 className='text-3xl font-bold text-gray-800 flex-nowrap'>
            Interview History
        </h1>
        <p className='text-gray-500 mt-2'>Track your past interview performance reports</p>
    </div>
</div>
...
{interviews.map((item,index)=>(
   ...
   className='bg-white p-6 rounded-2xl shadow-md hover:shadow-xl
    transition-all duration-300 cursor-pointer border border-gray-100'>
        ...
        <div className='flex flex-col mg:flex-row mg:items-center md:justify-between
        gap-4'>
            <div >
